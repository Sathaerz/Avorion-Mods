...
meta =
{
    ...
    title = "Arsenal Extension - Fusion Cannon",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new weapon to the game inspired by Descent's Fusion Cannon. The Fusion Cannon is an energy weapon that features a very low rate of fire, but devastating single-shot damage. Compared to a standard cannon, it fires more slowly and has a shorter range, but its shots are larger and travel more quickly. Has a chance of doing antimatter damage. This weapon uses the original sound effect from Descent when it fires. Available anywhere that a lightning gun can be found, but is a bit more rare.",
    ...
    -- },
    dependencies = {
        {id = "2584917526", exact = "*.*", incompatible = true},
        {id = "2842526757", exact = "*.*", incompatible = true},
