...
meta =
{
    ...
    name = "EradicateXsotan",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Eradicate Xsotan Infestation",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new, stand-alone mission that involves going into a sector heavily infested by the Xsotan and clearing it out. Be careful - the Xsotan have a few surprises even for the most hardened of veteran captains.",
