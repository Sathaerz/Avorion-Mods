...
meta =
{
    ...
    name = "DestroyStronghold",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Destroy Pirate Stronghold",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A nearby system is home to a heavily fortified pirate base, and your local faction needs your help to clean it ou! This mission is available at Military Outposts. The station is quite tough, so make sure to bring your heaviest firepower!",
