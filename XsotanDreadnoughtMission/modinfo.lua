...
meta =
{
    ...
    name = "XsotanDreadnoughtMission",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Destroy Xsotan Dreadnought",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Throw down with Hammelpilaw's fearsome Xsotan Dreadnought in this mission that tasks you with eliminating it. Stay sharp, though! I've added a few surprises of my own. :) This mission can be found at Military Outposts, Research Stations, and Resistance Outposts.",
