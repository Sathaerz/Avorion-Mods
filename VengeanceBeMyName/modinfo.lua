...
meta =
{
    ...
    name = "VengeanceBeMyName",

    -- Title of your mod that will be displayed to players
    title = "Vengeance Be My Name",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Vengeance be my Name is a polished 9-mission campaign set in the Trinium area, intended to be tackled around when the player has built a ship that has been fully made out of trinium. The rewards will provide a large amount of credits and a number of exotic subsystems to give the player a boost as they push into the Xanion area. This campaign does not require either the Black Market or ITR DLC to play. This mod features:\n\n- Nine new story missions.\n- Two new bosses to defeat.\n- Two new repeatable side missions that can be done after the campaign.\n\nRelative to Horizon Keepers, the missions are much more technically complicated but require less powerful ships to accomplish.\n\nPlease leave any feedback, and enjoy the extra content!",
    ...
    -- },
    dependencies = {
        {id = "2207469437", min = "1.7.53"},
        {id = "Avorion", min = "2.5.2", max = "*.*"}
    },
