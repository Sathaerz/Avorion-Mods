...
meta =
{
    ...
    title = "New Mission - Mineral Madness",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Your local faction is a little low on resources, so they've asked you to do some mining! Gather up as many raw ores as you can in a 30 minute window and drop them off at your nearest resource depot! Well, what are you waiting for? Go! Go! Go! This mission is an uncommon mission that can be found at any resource depot.",
