...
meta =
{
    ...
    title = "Random Boss Extensions - Timers",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A fixed copy of Nyrin's Boss Cooldown Timer mod that includes support for Lord of the Wastes and Core Encounters. Original mod here: https://steamcommunity.com/sharedfiles/filedetails/?id=2603954055",
