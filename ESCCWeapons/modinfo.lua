...
meta =
{
    ...
    description = "Adds all of the Arsenal Extension weapons to the various tables in ShipUtility, allowing pirates and other enemies to spawn with them. Despite the name, this does not require Extra Ship Classes Core to use.",
    ...
    -- },
    dependencies = {
        {id = "2532733728", exact = "*.*", optional = true},
        {id = "2537658830", exact = "*.*", optional = true},
        {id = "2537659039", exact = "*.*", optional = true},
        {id = "2539125971", exact = "*.*", optional = true},
        {id = "2540473355", exact = "*.*", optional = true},
        {id = "2556651648", exact = "*.*", optional = true},
        {id = "2556651689", exact = "*.*", optional = true},
        {id = "3016092256", exact = "*.*", optional = true},
        {id = "3024338660", exact = "*.*", optional = true},
        {id = "3016092361", exact = "*.*", optional = true},
        {id = "3482826383", exact = "*.*", optional = true},
