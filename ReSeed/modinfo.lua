...
meta =
{
    ...
    description = "Both increases and decreases the randomness of turret and upgrade seeds.  Instead of each 15x15 quadrant of the galaxy having 4 possible seeds for petty through exceptional weapons, each sector now has a single possible seed.  This means that weapons you get in an individual sector will be less random, but weapons in the galaxy overall will be more random, with 1,000,000 possible seeds instead of approximately 4,500.",
