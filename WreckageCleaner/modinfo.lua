...
meta =
{
    ...
    name = "WreckageCleaner",

    -- Title of your mod that will be displayed to players
    title = "Wreckage Cleaner",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Tired of cleaning up tiny scraps left behind by salvage fighters? Tired of chugging during large battles? Tired of drowning in garbage? De-kesslerize your galaxy in one easy step! This simple mod deletes and wreckage pieces that are 15 blocks and under. It will try not to delete any particularly expensive pieces of salvage, for those rare cases where you manage to blast a single shield block off of an enemy.",
