...
function Eternal.animation(direction)
    ...
    if _Version.major > 1 then
        _Sector:createHyperspaceJumpAnimation(Entity(), direction, ColorRGB(0.0, 1.0, 0.6), 0.2)
    else
        _Sector:createHyperspaceAnimation(Entity(), direction, ColorRGB(0.0, 1.0, 0.6), 0.2)
    end
end
