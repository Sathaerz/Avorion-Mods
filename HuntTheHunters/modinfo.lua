...
meta =
{
    ...
    title = "New Mission - Hunt The Hunters",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Inspired by all the complaints of 'relentless bounty hunters' comes Hunt The Hunters! This mission asks you to track down and eliminate members of the galactic bounty hunters guild. If they're already after you, it's just like getting paid twice! They might not be too happy that you've turned the tables, however...",
