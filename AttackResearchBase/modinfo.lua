...
meta =
{
    ...
    name = "AttackResearchBase",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Attack Research Base",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new, uncommon mission to Military Outposts that tasks you with destroying a nearby research base belonging to an enemy faction. Also contains a secret, incredibly dangerous boss encounter.",
