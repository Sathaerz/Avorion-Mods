...
meta =
{
    ...
    title = "Arsenal Extension - SRM Launcher",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A small missile launcher that offers unparalleled burst damage, the Short Range Missile - or SRM for short - belches out a cloud of fast seeking missiles. Don't let their small size and low DPS fool you - any unshielded hull will be torn to pieces in short order. These start appearing farther from the center of the galaxy than standard Launchers, but are just as common.",
