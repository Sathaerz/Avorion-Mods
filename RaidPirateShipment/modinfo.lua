...
meta =
{
    ...
    name = "RaidPirateShipment",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Raid Pirate Shipment",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A nearby pirate group is building a new type of weapon. Fortunately for your local faction, you can put a stop to them. This mission tasks you with raiding a convoy of pirate cargo ships, and pillaging their holds! This mission can be picked up from turret factory suppliers and turret factories.",
