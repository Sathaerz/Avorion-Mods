...
meta =
{
    ...
    title = "Arsenal Extension - Slug Gun",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A cross between a railgun and shotgun, the Slug Gun fires a wide spread of high-velocity projectiles that are capable of penetrating weak sections of a ship's hull. Slug Guns can be found anywhere that a railgun can be found, but they are slightly less common.",
