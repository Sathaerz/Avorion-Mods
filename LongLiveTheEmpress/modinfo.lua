...
meta =
{
    ...
    name = "LongLiveTheEmpress",

    -- Title of your mod that will be displayed to players
    title = "Long Live The Empress!",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Long Live The Empress is a fully-featured expansion campaign to the Cavaliers faction from the Black Market DLC. This mod features:\n- Five new story missions that take place after the defeat of The Family and The Commune\n- A new boss to defeat.\n- Five new side missions that can be undertaken repeatedly.\n- A sixth, secret side mission.\n- A new event.\n- Two new consumable items.\n\nPlease leave any feedback, and enjoy the extra content!",
