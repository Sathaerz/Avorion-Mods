...
meta =
{
    ...
    description = "Multiplies sector damage values by 75. This affects all player turrets, all NPC turrets, and all NPC turrets and torpedoes. Also divides the price of all weapons by 75, so they should cost roughly the same amount that they would cost normally.\n\nI have no plans to address any of the other side effects caused by amplifying the damage this much. You have been warned.",
