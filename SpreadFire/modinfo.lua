...
meta =
{
    ...
    title = "Arsenal Extension - Spreadfire Cannon",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new weapon to the game inspired by Descent 1's Spreadfire Cannon. The Spreadfire cannon is an energy weapon that alternates between a blast of three tightly-grouped shots, then three loosely-grouped shots. Works decently well against large groups of enemies. Spreadfire cannons can be found anywhere that a plasma gun can be found.",
