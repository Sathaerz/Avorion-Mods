...
meta =
{
    ...
    title = "Avorion: Michael Bay Edition",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Does literally nothing, except for making ship and station explosions MICHAEL BAY sized. When it comes to blowing up, this mod has no equal!",
