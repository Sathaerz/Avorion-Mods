...
meta =
{
    ...
    name = "DefendPrototype",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Defend Prototype Battleship",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "You've been destroying prototypes since 2020, but now it's time to defend one instead! Join your local faction in their war effort and defend their shiny new battleship from an all out pirate assault! This mission gets brutally difficult at the higher levels, so make sure you bring your strongest ships! This mission can be rarely found at Research Stations, Shipyards, or Military Outposts.",
