...
meta =
{
    ...
    name = "CollectPirateBounty",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Collect Pirate Bounty",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new, commonly encountered mission to Military Outposts and Smuggler Hideouts that tasks you with killing a set number of ships or stations from a specific pirate faction. How you find them and kill them is up to you, as long as they are eliminated!",
