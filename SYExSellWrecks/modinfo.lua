...
meta =
{
    ...
    title = "Scrapyard Extension - Sell Wreckages",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "An extension to the scrapyard script that adds a tab that allows players to sell wreckages in scrapyards. If a scrapyard has seen heavy use and is low on wreckages, it may pay more when bulk buying wreckages. It is also possible to sell wreckages by simply dropping them off in the sector.",
