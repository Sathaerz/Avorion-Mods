...
meta =
{
    ...
    name = "PulseAccelerator",

    -- Title of your mod that will be displayed to players
    title = "Arsenal Extension - Pulse Accelerator",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A deadly weapon that fires extremely powerful bursts of charged particles, the pulse accelerator is a fearsome sight on any capital ship. These are only available quite a distance into the galaxy, and are vanishingly rare. However, any captain who gets their hands on one of these will undoubtedly be feared by their opposition.",
