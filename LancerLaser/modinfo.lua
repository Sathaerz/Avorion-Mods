...
meta =
{
    ...
    title = "Arsenal Extension - Lancer",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Borrowing some design ideas from the Vauss Cannon, the Lancer is an always-coaxial laser that's available anywhere that you can find a standard Laser Turret. However, it is less common. Does not suffer from the same issues that impact the standard Laser (poor scaling / turret factory scaling).",
