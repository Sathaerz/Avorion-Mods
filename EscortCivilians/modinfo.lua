...
meta =
{
    ...
    name = "EscortCivilians",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Escort Civilian Transports",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new, uncommon mission to Military Outposts, Headquarters and Habitats that tasks you with escorting a convoy of civilian transports to safety.",
