...
meta =
{
    ...
    title = "Core Encounters",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds six difficult boss encounters that will randomly spawn in the core of the galaxy. The boss encounters will only appear after the player beats the Wormhole Guardian, and will spawn in a similar fashion to Swoks or the AI. The bosses are tuned to be much more difficult than the Wormhole Guardian, and will drop similar rewards.",
