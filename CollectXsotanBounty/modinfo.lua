...
meta =
{
    ...
    name = "CollectXsotanBounty",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Collect Xsotan Bounty",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "200 years ago, the Xsotan defeated the United Alliances and tore the subspace fabric of the galaxy to shreds. Today, you're getting hired to get rid of them. Join your local faction in their endless fight to drive the Xsotan back, and get paid in the process! This mission can be found at military outposts, research stations, and resistance outposts.",
