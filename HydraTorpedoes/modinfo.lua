...
meta =
{
    ...
    title = "Arsenal Extension - Hydra Torpedoes",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds ten new types of torpedoes to equipment docks for purchase. These torpedoes will split into multiple sub-munitions that independently seek the target. Each individual sub-munition doesn't do as much damage as the main torpedo, but all sub-munitions striking the target will do approximately 50% more damage than a standard torpedo. These torpedoes are rarer and 20% more expensive than standard torpedoes, and don't appear until closer to the center of the galaxy than a standard torpedo of the corresponding type.",
