...
meta =
{
    ...
    title = "Arsenal Extension - Vauss Cannon",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new weapon to the game inspired by Descent 3's Vauss Cannon. The Vauss Cannon is an always-coaxial weapon similar to a chaingun with significantly increased shot velocity and range. Vauss Cannons are available anywhere that a chaingun is available (i.e. anywhere in the galaxy)",
