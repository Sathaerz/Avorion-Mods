...
meta =
{
    ...
    description = "A much more extreme version of ReSeed. This decouples the tech level and sector DPS values from the progression to the center of the galaxy, and it makes it so all weapons / upgrades generate with a random seed.",
    ...
    dependencies = {
        ...
        {id = "2442089978", exact = "*.*", incompatible = true},
