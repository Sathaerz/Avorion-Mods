...
meta =
{
    ...
    name = "DisruptPirateMiners",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Disrupt Pirate Miners",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A group of pirates has set up an illegal mining operation in your local faction's territory, and they need your help to take it out! Blast pirate miners as they trickle into a nearby asteroid belt, and scoop up all of the ores they're carrying with them! Just make sure you unbrand them before you try to refine them. This is a common mission that can be found at both military outposts and resource depots.",
