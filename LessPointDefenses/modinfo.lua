...
meta =
{
    ...
    name = "LessPointDefenses",

    -- Title of your mod that will be displayed to players
    title = "Less Point Defenses!",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Are you tired of your inventory getting flooded with point defense lasers and chainguns? Are you tired of getting excited for a legendary turret drop, only to find out that it's an anti-fighter turret? Well, I've got excellent news for you, my friend. After installing this mod, point defense chainguns and lasers are 1/4 as likely to drop, and anti-fighter turrets are 1/8 as likely to drop (relative to the previous ratio of drops), and you will never see a legendary point defense or anti-fighter turret drop from an enemy.\n\n!!!WARNING!!! This may break compatibility with other weapon mods, depending on if they modify the 'generate' and 'generateArmed' functions in SectorTurretGenerator.lua.",
