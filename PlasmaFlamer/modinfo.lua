...
meta =
{
    ...
    title = "Arsenal Extension - Plasma Flamer",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Inspired by HET's Flamethrower turret, the plasma flamer fires a short-ranged stream of energy that does massive damage to shields. Tear down your enemy's defenses in seconds with these terrifying weapons.",
