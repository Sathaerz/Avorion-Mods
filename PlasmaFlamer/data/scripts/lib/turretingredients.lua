TurretIngredients[WeaponType.PlasmaFlamer] =
{
    ...
    {name = "Fuel",                 amount = 5,    investable = 7,  minimum = 1,    weaponStat = "shieldDamageMultiplier", investFactor = 0.1, changeType = StatChanges.Percentage},
