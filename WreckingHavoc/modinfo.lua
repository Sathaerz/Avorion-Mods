...
meta =
{
    ...
    title = "New Mission - Wrecking Havoc",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new, commonly encountered mission to scrapyards that tasks you with dropping off as many wreckages as possible at the scrapyard within the next 30 minutes. How you retrieve the wreckages is entirely up to you!",
