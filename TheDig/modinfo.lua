...
meta =
{
    ...
    title = "New Mission - The Dig",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds a new mission to Resource Depots that tasks you with protecting a group of miners while they harvest asteroids from a super rich patch of resources. You're welcome to take some for yourself, but beware any potential threats that may show up...",
