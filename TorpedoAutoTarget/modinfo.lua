...
meta =
{
    ...
    name = "TorpedoAutoTarget",

    -- Title of your mod that will be displayed to players
    title = "Torpedo Auto-Targeting",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "The original mod is here: https://steamcommunity.com/sharedfiles/filedetails/?id=2592647283 - Nyrin hasn't been heard from in a long time, so I figured out what was wrong with the original mod and fixed it myself.",
