...
meta =
{
    ...
    title = "New Mission - Scrap Delivery",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Your local faction is running a little low on resources, so they've asked you to do some scrapping! Unlike Scrap Scramble, you'll only be asked to drop off a fixed amount of scrap rather than as much as you can find in a 30 minute window. This mission commonly appears at Scrapyards.",
