...
meta =
{
    ...
    title = "New Mission - The Annihilatorium",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "You there! Step right up! Come on down to The Annihilatorium, where we've recruited the meanest, nastiest, and toughest pirates on this side of the galaxy! They'd love to give your ship a good stomping - show them that you're made of sterner stuff! This mission can be found at any Smuggler Outpost or Casino! Give those pirates a show they'll never forget!",
