--[[
    SIDE MISSION 2: Operation Xsology
]]
...
mission.makeBulletin = function(_Station)
    ...
    local bulletin =
    {
        ...
        msg = "We tracked down XSOLOGIZE Mk II earlier. Meet me at \\s(%1%:%2%) and we'll go over the plan.",
        ...
        arguments = {{
            ...
            location = target,
            reward = {credits = reward, paymentMessage = "Earned %1% credits for destroying XSOLOGIZE Mk II."}
        }},
    }
