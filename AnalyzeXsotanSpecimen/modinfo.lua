...
meta =
{
    ...
    name = "AnalyzeXsotanSpecimen",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Analyze Xsotan Specimen",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "The Xsotan are an ever-present threat. However, some Xsotan are more threatening than others. Join your local faction in their attempts to figure out more about these dangerous and powerful Xsotan, and get paid in the process! This mission can be commonly found at any Research Station or Resistance Outpost.",
    ...
    dependencies = {
        ...
        {id = "3411023648", exact = "*.*", optional = true},
        {id = "3373069547", exact = "*.*", optional = true},
        {id = "3406545523", exact = "*.*", optional = true},
        {id = "3385251675", exact = "*.*", optional = true},
        {id = "Avorion", min = "2.3", max = "*.*"}
    },
