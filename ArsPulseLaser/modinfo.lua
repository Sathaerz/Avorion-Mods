...
meta =
{
    ...
    title = "Arsenal Extension - Pulse Laser",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Pulse lasers differ from traditional laser weaponry in that instead of firing one powerful beam, they maintain short bursts of light fired off in quick succession. These versatile and powerful weapons will serve you well from the Iron Wastes to the Galaxy Core.",
