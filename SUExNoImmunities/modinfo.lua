...
meta =
{
    ...
    name = "SUExNoImmunities",

    -- Title of your mod that will be displayed to players
    title = "Spawn Utility Extension - No Immunities",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Gets rid of enemy damage type immunities on shields. Enemy shield damage resistance will not exceed 70% while this mod is active.",
