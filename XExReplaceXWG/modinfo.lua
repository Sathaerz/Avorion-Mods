...
meta =
{
    ...
    title = "Xsotan Extension - Replace XWG",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This mod simply replaces the XWG with an prebuilt plan of your choice, provided the XML is available. The default plan is the Ra World Mothership by Arch Makon 5803.\n\nTO REPLACE THE XWG:\n- Find this mod's folder in your steam workshop content folder\n- Delete or rename XWG.xml\n- Find your avorion install folder\n- Locate data/plans \n- Place the plan you want to replace the XWG with in that folder\n- Rename the plan XWG.xml\n\nEnjoy!\n\nMade at the request of Ren Atlas.",
