...
meta =
{
    ...
    name = "ScanXsotanGroup",

    -- Title of your mod that will be displayed to players
    title = "New Mission - Scan Xsotan Group",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Your local faction would like to know more about their ancient enemy - the Xsotan - and so you've been chosen to head into the thick of a group of Xsotan ships and scan them. This mission can be found at Military Outposts, Research Stations, and Resistance Outposts.",
